...
import { ZAxis, Scatter, ScatterChart, ResponsiveContainer, AreaChart, CartesianGrid, XAxis, YAxis, Tooltip, Area, Line, Legend, LineChart, Bar, BarChart, Pie, PieChart, Cell } from 'recharts';
